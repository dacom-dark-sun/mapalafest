        ...
        <div class="row no-gutters who-welcome-item">
            <div class="col-12 col-xs-12 col-lg-8 guests">
                ...
                <div class="who-welcome-item__content">
                      ...
                      <p>Ты найдешь способы заработка и самореализации в Цифровом Мире.</p>
            ...
            <div class="col-12 col-xs-12 col-lg-8 guests">
                <div class="row row-reset justify-content-between">
                  ...
                  <div class="who-welcome-item__content col">
                    ...
                    <p>Как применить блокчейн в бизнесе и извлечь из этого выгоду.</p>
                  </div>
        ...
        <div class="row no-gutters who-welcome-item">
            <div class="col-12 col-xs-12 col-lg-8 guests">
                ...
                <div class="who-welcome-item__content">
                    ...
                    <p>Огромный, высооплачиваемый рынок труда, где не требуется ходить в офис.</p>
                </div>
                <div class="guests3">
                </div>
            </div>
        ...
        <div class="row text-center align-items-stretch">
            <div class="plan-standart col-xs-12 col-lg-6">
                ...
                <ul>
                    ...
                    <li><span>Введение в Цифровую Экономику от спикеров со всей страны</span></li>
                    <li><span>100 FestCoins, которые можно обменять на сувениры или еду</span></li>
                    <li><span>Мастер-классы по йоге, альтернативной медицине и педагогике</span></li>
                    <li><span>Мужские игры и соревнования</span></li>
