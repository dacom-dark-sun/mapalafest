...
<script type="text/javascript" >
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter45721044 = new Ya.Metrika({
                    id:45721044,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/45721044" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-auto">
                <div class="map-current row main_scena" style="">
                    ...
                    <p>Почему 120 рублей за доллар - этой зимой? Почему цифровая экономика? Как ей пользоваться и извлекать выгоду?</p>
                ...
                <div class="map-current row tanspol" style="">
                    ...
                    <p>Качественная этническая и электронная музыка расслабит после глубокого информационного погружения</p>
                ...
                <div class="map-current row market" style="">
                    ...
                    <p class = "market">Ярмарка мастеров еды и искусств покажет мастерство умельцев</p>
            ...
            <div class="col-12 col-xs-12 col-lg-8 guests">
                <div class="row row-reset justify-content-between">
                  ...
                  <div class="who-welcome-item__content col">
                    ...
                    <p>Ты узнаешь, как применить блокчейн в бизнесе, заняв новый рынок в числе первых.</p>
                  </div>
        ...
        <div class="row no-gutters who-welcome-item">
            <div class="col-12 col-xs-12 col-lg-8 guests">
                ...
                <div class="who-welcome-item__content">
                    ...
                    <p>Огромный, высооплачиваемый рынок труда, где 10-ю пальцами меняется мир.</p>
                </div>
                <div class="guests3">
                </div>
            </div>
            ...
            <div class="col-12 col-xs-12 col-lg-8 guests">
                <div class="row row-reset justify-content-between">
                  ...
                  <div class="who-welcome-item__content col">
                    ...
                    <p>Поток информации из первых уст с самой передовой Цифрового Мира.</p>
                  </div>
    ...
    <div class="plan__title text-center">
        ...
        <div class="row text-center align-items-stretch">
            <div class="plan-standart col-xs-12 col-lg-6">
                <h1>Включено:</h1>
                <ul>
                    <li><span>Качественный этнический транс пробудит твою энергию</span></li>
                    <li><span>Спикеры передадут свои знания о Цифровом Мире</span></li>
                    <li><span>Ты получишь 100 FestCoins, которые можно обменять на сувениры или еду на территории фестиваля в форме игры</span></li>
                    <li><span>Ты поучаствуешь в мастер-классах</span></li>
                    <li><span>Ты покажешь силу на мужских играх, и смекалку в квестах</span></li>
