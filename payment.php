...
if(!preg_match('/^[a-zA-Z0-9\._-]{4,}$/', $_POST['nickname'])){
	echo '{"error" : 1, "message": "Для регистрации в блокчейне не подходят любые символы, кроме латинских букв, цифр, точки и тире. Число символов - не менее 4. Повторите ввод, пожалуйста.."}';
	die();
}
